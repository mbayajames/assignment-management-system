...
db.User.belongsToMany(db.Assignment, { through: 'AssignmentUsers', foreignKey: 'userId' });
db.Assignment.belongsToMany(db.User, { through: 'AssignmentUsers', foreignKey: 'assignmentId' });
